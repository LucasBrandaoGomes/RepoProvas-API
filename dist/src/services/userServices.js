...
exports.newLogin = exports.newUser = void 0;
...
function checkPassword(result, password) {
    var confirmPassword = bcrypt_1["default"].compareSync(password, result.password);
    if (!confirmPassword) {
...
function newUser(email, password) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    passwordCript = bcrypt_1["default"].hashSync(password, 10);
                    return [4 /*yield*/, checkIfEmailRegistered(email)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, userRepository.inserNewUser(email, passwordCript)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    id = result.id;
                    token = jsonwebtoken_1["default"].sign(String(id), secretKey);
